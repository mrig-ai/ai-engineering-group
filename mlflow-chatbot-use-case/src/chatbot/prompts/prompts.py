multi_query_prompt = """
    ...
    Your goal is to transform the **User Question** into optimized search questions while identifying the source language.
...
- Do NOT translate the question yourself; pass the original language string to the tool.
